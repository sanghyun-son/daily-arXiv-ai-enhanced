...
class TestSubmitBatch:
    ...
    def test_create_batch_requests_language_integration(self, sample_data):
        ...
        system_message_chinese = batch_requests_chinese[0]["body"]["messages"][
            0
        ]["content"]
    ...
    def test_submit_batch_job_success(self, mock_openai, temp_data_file):
        ...
        os.environ["MODEL_NAME"] = "gpt-5-mini"
    ...
    @patch("submit_batch.OpenAI")
    def test_submit_batch_job_file_upload_failure(
        self, mock_openai, temp_data_file
    ):
    ...
    @patch("submit_batch.OpenAI")
    def test_submit_batch_job_batch_creation_failure(
        self, mock_openai, temp_data_file
    ):
        ...
        mock_client.batches.create.side_effect = Exception(
    ...
    def test_submit_batch_job_batch_info_file_creation(self, temp_data_file):
        ...
        with patch("submit_batch.OpenAI") as mock_openai:
            ...
            batch_info_file = temp_data_file.replace(
                ".jsonl", "_batch_info.json"
            )
            assert os.path.exists(batch_info_file)
